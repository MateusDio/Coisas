...
public class ConexaoVIEW extends javax.swing.JFrame {
    ...
    public ConexaoVIEW() {
        ...
        if (conn != null) {
            labelImagem.setIcon(new ImageIcon(getClass().getResource("/DTO/verde.png")));
        } else {
            labelImagem.setIcon(new ImageIcon(getClass().getResource("/VIEW/vermelho.png")));
        }
    }
    ...
    private void initComponents() {
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addComponent(jLabel4)
                .addGap(18, 18, 18)
                .addComponent(labelImagem, javax.swing.GroupLayout.PREFERRED_SIZE, 26, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(35, 35, 35))
        );
